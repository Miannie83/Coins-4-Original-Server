...
LOG_CFG_CANLIFT=[
	...
	"m6_ep1",
	"mh6j_dz",
	"Mi17_Civilian",			//Mi-17 Hip-H Civilian helicopter White with blue trim
	"Mi17_Civilian_DZ",			//Mi-17 Hip-H Civilian helicopter White with blue trim
	"Mi17_DZ",				//Mi-17 Hip-H Civilian helicopter White with blue trim
	"Mi17_medevac_CDF",			//Mi-17 Hip-H MediVac helicopter
	"Mi17_medevac_INS",			//Mi-17 Hip-H MediVac helicopter
	"Mi17_medevac_RU",			//Mi-17 Hip-H MediVac helicopter
	"Mi17_UN_CDF_EP1",			//Mi-17 Hip-H UN helicopter White
	"MH60S",				//Knighthawk US Navy blackhawk
	"Mi17_Ins",				//Mi-17 Hip-H helicopter Desert Cam
	"Mi17_CDF",				//Mi-17 Hip-H multirole helicopter PKT 7.62 Machine guns
	"Mi17_rockets_RU",			//Mi-17 Hip-H Assault helicopter 57mm rocket launcher
	"Mi17_TK_EP1",				//Mi-17 Hip-H multirole helicopter PKT 7.62 Machine guns
	"Mi171Sh_CZ_EP1",			//Mi-17 Hip-H multirole helicopter PKT 7.62 Machine guns
	"Mi171Sh_rockets_CZ_EP1",		//Mi-17 Hip-H Assault helicopter 57mm rocket launcher
	"Mi24_D",				//Mi-24 Hind Russian helicopter gunship
	"Mi24_D_TK_EP1",			//Mi-24 Hind Russian helicopter gunship Desert Cam
	"Mi24_P",				//Mi-24 Hind Russian helicopter gunship
	"Mi24_V",				//Mi-24 Hind Russian helicopter gunship
	"UH1H_DZ",				//Bell UH-1 Iroquois Huey 2x m240 LMG
	"UH1H_TK_GUE_EP1",			//Bell UH-1 Iroquois Huey 2x m240 LMG
	"UH1Y_DZ",				//UH-1Y Venom Mk66 70 mm rocket stations and two M240D 7.62 mm machine guns
	"UH60M_EP1",				//Blackhawk 2x M134 Minigun
	"UH60M_EP1_DZ",				//Blackhawk 2x M134 Minigun
	"UH60M_EP1_DZE",			//Blackhawk 2x M134 Minigun	
	"mq9predatorb_us_ep1",
	"mv22_dz",
	"su25_cdf",
	"su25_ins",
